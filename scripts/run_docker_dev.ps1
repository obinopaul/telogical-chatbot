# PowerShell script to run Docker Compose in development mode
...
$composeFilePath = Join-Path $projectRoot "docker\compose.dev.yml"
$envFilePath = Join-Path $projectRoot ".env"

# Print information
Write-Host "Starting Docker Compose for Telogical Chatbot (Development Mode)..."
